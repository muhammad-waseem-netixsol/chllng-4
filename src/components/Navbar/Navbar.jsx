...
const Navbar = (props) => {
    ...
    const topWrapperHandle = status => {
        ...
        props.handleTop(true);
    }
    return (
        <div className={` z-10 flex justify-between items-center py-3 `}>
             <div data-aos="fade-left">
                <NavSvg />
             </div>
             <div className='flex justify-center items-center gap-2' data-aos="fade-right">
                <div><CartIcon /></div>
                <button style={{ fontFamily: 'Mona Sans, sans-serif' }} className={`bg-black rounded-full sm:px-5 px-3 py-2 text-base font-medium capitalize text-white hidden md:block`}>contact us</button>
